...
header {
     ...
     h3 {
        ...
        .product-card a:hover p {
            ...
            color: rgb(219, 64, 29); /* Optional hover color */
        }

        .product-card a {
            text-decoration: none !important; /* Force removal of underline */
            color: inherit !important; /* Ensure the link uses the parent color */
        }

        .product-card a:visited {
            color: inherit !important; /* Remove visited link color */
        }
              .customizer-banner {
            position: absolute;
            top: 100px;
            right: 10px;
            background-color: #f39c12; /* Eye-catching color */
            color: white;
            padding: 10px 20px;
            border-radius: 5px;
...
.search-bar input[type="text"]:focus {
    width: 80%;
    background-color: rgba(34, 3, 3, 0.2);
}
  ...
  <path d="M1.75 1.002a.75.75 0 1 0 0 1.5h1.835l1.24 5.113A3.752 3.752 0 0 0 2 11.25c0 .414.336.75.75.75h10.5a.75.75 0 0 0 0-1.5H3.628A2.25 2.25 0 0 1 5.75 9h6.5a.75.75 0 0 0 .73-.578l.846-3.595a.75.75 0 0 0-.578-.906 44.118 44.118 0 0 0-7.996-.91l-.348-1.436a.75.75 0 0 0-.73-.573H1.75ZM5 14a1 1 0 1 1-2 0 1 1 0 0 1 2 0ZM13 14a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z" />
    ...
    Cart
     ...
     <main>
        ...
        <p>Try our 3D Customizer!</p>
        <a href="../3d-shirt-customizer/index.html">Go to 3D Customizer</a>
    </div>
